        ...
        <div class="col-md-offset-2 col-md-8">
            ...
            {!! csrf_field() !!}
                <div class="row m-b-30">
                    ...
                    <div class="col-md-4 col-sm-4">
                        <label>Turma</label>
                        <input type="text" maxlength="20" required class="form-control" data-msg="Informe a turma" name="class"/>
                    </div>
                    <div class="col-md-4 col-sm-4">
                ...
                <div class="row">
                    <table class="table">
                        ...
                        <tr>
                             ...
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório" required class="form-control atual atual_1" name="1_A_1"/>
                             </td>
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control preferida preferida_1" name="1_A_2"/>
                             </td>
                        </tr>
                        <tr>
                             <td width="10%">B</td>
                             ...
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control atual atual_1" name="1_B_1"/>
                             </td>
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control preferida preferida_1" name="1_B_2"/>
                             </td>
                        </tr>
                        <tr>
                             <td width="10%">C</td>
                             ...
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control atual atual_1" name="1_C_1"/>
                             </td>
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control preferida preferida_1" name="1_C_2"/>
                             </td>
                        </tr>
                        <tr>
                             <td width="10%">D</td>
                             ...
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control atual atual_1" name="1_D_1"/>
                             </td>
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control preferida preferida_1" name="1_D_2"/>
                             </td>
                        </tr>
                         <tr>
                             <td width="10%"></td>
                        ...
                        <tr>
                             ...
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control atual atual_2" name="2_A_1"/>
                             </td>
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control preferida preferida_2" name="2_A_2"/>
                             </td>
                        </tr>
                        <tr>
                             <td width="10%">B</td>
                             ...
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control atual atual_2" name="2_B_1"/>
                             </td>
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control preferida preferida_2" name="2_B_2"/>
                             </td>
                        </tr>
                        <tr>
                             <td width="10%">C</td>
                             ...
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control atual atual_2" name="2_C_1"/>
                             </td>
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control preferida preferida_2" name="2_C_2"/>
                             </td>
                        </tr>
                        <tr>
                             <td width="10%">D</td>
                             ...
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control atual atual_2" name="2_D_1"/>
                             </td>
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control preferida preferida_2" name="2_D_2"/>
                             </td>
                        </tr>
                         <tr>
                             <td width="10%"></td>
                        ...
                        <tr>
                             ...
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control atual atual_3" name="3_A_1"/>
                             </td>
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control preferida preferida_3" name="3_A_2"/>
                             </td>
                        </tr>
                        <tr>
                             <td width="10%">B</td>
                             ...
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control atual atual_3" name="3_B_1"/>
                             </td>
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control preferida preferida_3" name="3_B_2"/>
                             </td>
                        </tr>
                        <tr>
                             <td width="10%">C</td>
                             ...
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control atual atual_3" name="3_C_1"/>
                             </td>
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control preferida preferida_3" name="3_C_2"/>
                             </td>
                        </tr>
                        <tr>
                             <td width="10%">D</td>
                             ...
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control atual atual_3" name="3_D_1"/>
                             </td>
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control preferida preferida_3" name="3_D_2"/>
                             </td>
                        </tr>
                         <tr>
                             <td width="10%"></td>
                        ...
                        <tr>
                             ...
                             <td width="10%"> 
                                <input type="text" maxlength="2" data-msg="Obrigatório" required class="form-control atual atual_4" name="4_A_1"/>
                             </td>
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control preferida preferida_4" name="4_A_2"/>
                             </td>
                        </tr>
                        <tr>
                             <td width="10%">B</td>
                             ...
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório" required class="form-control atual atual_4" name="4_B_1"/>
                             </td>
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório" required class="form-control preferida preferida_4" name="4_B_2"/>
                             </td>
                        </tr>
                        <tr>
                             <td width="10%">C</td>
                             ...
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório" required class="form-control atual atual_4" name="4_C_1"/>
                             </td>
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório" required class="form-control preferida preferida_4" name="4_C_2"/>
                             </td>
                        </tr>
                        <tr>
                             <td width="10%">D</td>
                             ...
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório" required class="form-control atual atual_4" name="4_D_1"/>
                             </td>
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório" required class="form-control preferida preferida_4" name="4_D_2"/>
                             </td>
                        </tr>
                         <tr>
                             <td width="10%"></td>
                        ...
                        <tr>
                             ...
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório" required class="form-control atual atual_5" name="5_A_1"/>
                             </td>
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control preferida preferida_5" name="5_A_2"/>
                             </td>
                        </tr>
                        <tr>
                             <td width="10%">B</td>
                             ...
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control atual atual_5" name="5_B_1"/>
                             </td>
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control preferida preferida_5" name="5_B_2"/>
                             </td>
                        </tr>
                        <tr>
                             <td width="10%">C</td>
                             ...
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório" required class="form-control atual atual_5" name="5_C_1"/>
                             </td>
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório" required class="form-control preferida preferida_5" name="5_C_2"/>
                             </td>
                        </tr>
                        <tr>
                             <td width="10%">D</td>
                             ...
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório" required class="form-control atual atual_5" name="5_D_1"/>
                             </td>
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório" required class="form-control preferida preferida_5" name="5_D_2"/>
                             </td>
                        </tr>
                         <tr>
                             <td width="10%"></td>
                        ...
                        <tr>
                             ...
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório" required class="form-control atual atual_6" name="6_A_1"/>
                             </td>
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório" required class="form-control preferida preferida_6" name="6_A_2"/>
                             </td>
                        </tr>
                        <tr>
                             <td width="10%">B</td>
                             ...
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório" required class="form-control atual atual_6" name="6_B_1"/>
                             </td>
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório" required class="form-control preferida preferida_6" name="6_B_2"/>
                             </td>
                        </tr>
                        <tr>
                             <td width="10%">C</td>
                             ...
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório" required class="form-control atual atual_6" name="6_C_1"/>
                             </td>
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório" required class="form-control preferida preferida_6" name="6_C_2"/>
                             </td>
                        </tr>
                        <tr>
                             <td width="10%">D</td>
                             ...
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control atual atual_6" name="6_D_1"/>
                             </td>
                             <td width="10%">
                                <input type="text" maxlength="2" data-msg="Obrigatório"  required class="form-control preferida preferida_6" name="6_D_2"/>
                             </td>
                        </tr>
                         <tr>
                             <td width="10%"></td>
